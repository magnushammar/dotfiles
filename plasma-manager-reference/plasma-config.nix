{
  programs.plasma = {
    enable = true;
    shortcuts = {
      "ActivityManager"."switch-to-activity-ee719fa1-6cd6-4966-9263-5ea246107e6e" = [ ];
    ...
    configFile = {
      ...
      "kactivitymanagerdrc"."activities"."ee719fa1-6cd6-4966-9263-5ea246107e6e".value = "Default";
      "kactivitymanagerdrc"."main"."currentActivity".value = "ee719fa1-6cd6-4966-9263-5ea246107e6e";
      ...
      "khotkeysrc"."Data_2_1Triggers0"."Uuid".value = "{b9ec0594-ccfa-4964-8633-b0a5be55d793}";
      ...
      "khotkeysrc"."Data_2_2Triggers0"."Uuid".value = "{6bb9e9fb-2cc3-4189-8fd1-a58655a6e72f}";
      ...
      "khotkeysrc"."Data_2_3Triggers0"."Uuid".value = "{0a4d1d75-b9f7-43e6-a2e1-9b960cbb448b}";
      ...
      "khotkeysrc"."Data_2_4Triggers0"."Uuid".value = "{3888c3dc-5ec9-4ad9-ae36-6c1f1c63f8aa}";
      ...
      "khotkeysrc"."Data_2_5Triggers0"."Uuid".value = "{cd8bba16-6330-4f4a-b731-0c78a9f4ce82}";
      ...
      "khotkeysrc"."Data_2_6Triggers0"."Uuid".value = "{4c8f60e9-2e26-476a-829e-4dc4bdac097c}";
      ...
      "khotkeysrc"."Data_2_8Triggers0"."Uuid".value = "{bd4913a8-de11-414e-bddb-81e88037f7e7}";
      ...
      "kwinrc"."Desktops"."Id_1".value = "f82e57a8-b0d7-4846-967e-52de574523a5";
      "kwinrc"."Desktops"."Number".value = 1;
      "kwinrc"."Desktops"."Rows".value = 1;
      "kwinrc"."Tiling"."padding".value = 4;
      "kwinrc"."Tiling/570dcab0-dc7c-533e-b469-1113d0ad438e"."tiles".value = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "plasma-localerc"."Formats"."LANG".value = "en_US.UTF-8";
      "plasma-localerc"."Formats"."LC_ADDRESS".value = "sv_SE.UTF-8";
      "plasma-localerc"."Formats"."LC_MEASUREMENT".value = "en_SE.UTF-8";
      "plasma-localerc"."Formats"."LC_MONETARY".value = "en_SE.UTF-8";
      "plasma-localerc"."Formats"."LC_NAME".value = "sv_SE.UTF-8";
      "plasma-localerc"."Formats"."LC_NUMERIC".value = "en_SE.UTF-8";
      "plasma-localerc"."Formats"."LC_PAPER".value = "en_SE.UTF-8";
      "plasma-localerc"."Formats"."LC_TELEPHONE".value = "sv_SE.UTF-8";
      "plasma-localerc"."Formats"."LC_TIME".value = "en_SE.UTF-8";
    };
  };
}
